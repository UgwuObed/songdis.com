...
const Aboutdata: datatype[] = [
    {
        ...
        country: "Nigeria",
        paragraph: 'Connecting artists and listeners in Nigeria through seamless music distribution and promotion.',
    },
    {
        imgSrc: "/assets/network/america.svg",
        country: "United States",
        paragraph: 'Empowering artists in the United States with global music distribution and analytics to enhance their reach.',
    },
    {
        imgSrc: "/assets/network/australia.svg",
        country: "Africa",
        paragraph: 'Supporting Africa musicians with efficient music distribution channels and promotional opportunities.',
    },
    {
        imgSrc: "/assets/network/china.svg",
        country: "Local",
        paragraph: 'Expanding the reach of Local artists worldwide with streamlined music distribution and strategic marketing.',
    },
]
    ...
    return (
        <div className="bg-babyblue" id="project">
            <div className="mx-auto max-w-2xl py-20 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <h3 className="text-4xl sm:text-6xl font-semibold text-center my-10 lh-81">Our Global Music Distribution Network</h3>

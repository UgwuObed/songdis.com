    ...
    return (
        <div className="mx-auto max-w-2xl py-40 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="bg-image-what">
                <h6 className='text-navyblue text-center text-4xl lg:text-6xl font-400'>Join 10k + Songdis  Artists
                We provide the tools and services you need to succeed in all stages of your career.</h6>
